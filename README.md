...
[![Pillow 12.1.1](https://img.shields.io/badge/Pillow-12.1.1-blue.svg)](https://pypi.org/project/Pillow/)
...
The project is based on Python 3.10.11 and utilizes the Pillow library (version 12.1.1) to manipulate images.
