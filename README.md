...
[![Pillow 12.2.0](https://img.shields.io/badge/Pillow-12.2.0-blue.svg)](https://pypi.org/project/Pillow/)
...
The project is based on Python 3.10.11 and utilizes the Pillow library (version 12.2.0) to manipulate images.
